...
1. Fei Gao, Jingjie Zhu, Weiyu Weng, Chenyang Jiang, Xiang Li, Xiao Zhu, Lingna Dai, **Peng Li**. High-quality Face Sketch Synthesis via Geometric Normalization and Regularization. Accepted by the 31st International Joint Conference on Artificial Intelligence (IJCAI 2022).
1. Wenqi Zhang, Kai Zhao, **Peng Li**, Xiao Zhu, Yongliang Shen, Yanna Ma, Yingfeng Chen, Weiming Lu, A Closed-Loop Perception, Decision-Making and Reasoning Mechanism for Human-Like Navigation. Accepted by In Proceedings of the 54th Annual IEEE/ACM International Symposium on Microarchitecture (MICRO 2021), pages 977-991, October 16-20, 2021, Athens, Greece
